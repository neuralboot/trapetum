...
captures GPU, driver, CUDA version, and seed in its outputs. The CUDA kernels are in
\texttt{kernels/}, the model-level scripts in \texttt{model/}, the quantization
benchmark in \texttt{bench/}, and this paper in \texttt{paper/}.
\begin{center}
